...
@:multiReturn extern class Multireturn<T0, T1, T2, T3, T4, T5> {
	public var _0:T0;
	public var _1:T1;
	public var _2:T2;
	public var _3:T3;
...
abstract Return2<T0, T1>(Array<Any>) {
	...
	inline function get__0():T0 {
		return this[0];
	}

	public var _1(get, never):T1;

	inline function get__1():T1 {
		return this[1];
	}
}

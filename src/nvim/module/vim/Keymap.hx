...
extern class Keymap {
	...
	**/
	@:luaDotMethod
	function del(modes:haxe.extern.EitherType<String, Array<String>>, lhs:String, ?opts:nvim.type.vim.keymap.del.Opts):Dynamic;
	/**
		```lua
	...
	**/
	@:luaDotMethod
	function set(mode:haxe.extern.EitherType<String, Array<String>>, lhs:String, rhs:haxe.extern.EitherType<String, haxe.Constraints.Function>, ?opts:nvim.type.vim.keymap.set.Opts):Dynamic;
}
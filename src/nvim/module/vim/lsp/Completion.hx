...
extern class Completion {
	...
	**/
	@:luaDotMethod
	function enable(enable:Bool, client_id:Int, bufnr:Int, ?opts:nvim.type.vim.lsp.completion.BufferOpts):Dynamic;
	/**
		```lua
	...
	**/
	@:luaDotMethod
	function get(?opts:nvim.type.vim.lsp.completion.get.Opts):Dynamic;
}
...
@:structInit class Entry {
	...
	**/
	@:optional
	extern public var curhead : Null<Float>;
	/**
		```lua
	...
	**/
	@:optional
	extern public var newhead : Null<Float>;
	/**
		```lua
	...
	**/
	@:optional
	extern public var save : Null<Float>;
	/**
		```lua

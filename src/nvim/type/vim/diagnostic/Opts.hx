...
@:structInit class Opts {
	...
	**/
	@:optional
	extern public var float : Null<haxe.extern.EitherType<Bool, haxe.extern.EitherType<nvim.type.vim.diagnostic.opts.Float, (namespace:Float, bufnr:Float) -> nvim.type.vim.diagnostic.opts.Float>>>;
	/**
		```lua
	...
	**/
	@:optional
	extern public var signs : Null<haxe.extern.EitherType<Bool, haxe.extern.EitherType<nvim.type.vim.diagnostic.opts.Signs, (namespace:Float, bufnr:Float) -> nvim.type.vim.diagnostic.opts.Signs>>>;
	/**
		```lua
	...
	**/
	@:optional
	extern public var underline : Null<haxe.extern.EitherType<Bool, haxe.extern.EitherType<nvim.type.vim.diagnostic.opts.Underline, (namespace:Float, bufnr:Float) -> nvim.type.vim.diagnostic.opts.Underline>>>;
	/**
		```lua
	...
	**/
	@:optional
	extern public var virtual_lines : Null<haxe.extern.EitherType<Bool, haxe.extern.EitherType<nvim.type.vim.diagnostic.opts.VirtualLines, (namespace:Float, bufnr:Float) -> nvim.type.vim.diagnostic.opts.VirtualLines>>>;
	/**
		```lua
	...
	**/
	@:optional
	extern public var virtual_text : Null<haxe.extern.EitherType<Bool, haxe.extern.EitherType<nvim.type.vim.diagnostic.opts.VirtualText, (namespace:Float, bufnr:Float) -> nvim.type.vim.diagnostic.opts.VirtualText>>>;
}
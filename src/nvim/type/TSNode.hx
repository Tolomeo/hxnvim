	...
	**/
	...
	/**
		...
		---
		 ...
		 child node.
	**/
	extern function iter_children():() -> nvim.helper.Multireturn<nvim.type.TSNode, String, nvim.helper.Nothing, nvim.helper.Nothing, nvim.helper.Nothing, nvim.helper.Nothing>;
	/**
		```lua

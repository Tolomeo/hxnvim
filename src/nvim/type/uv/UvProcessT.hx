...
@:structInit class UvProcessT {
	...
	**/
	...
	/**
		...
		```
	**/
	extern function kill(signum:haxe.extern.EitherType<Int, String>):nvim.helper.Multireturn<Null<Float>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>, Void, Void, Void>;
	/**
		```lua

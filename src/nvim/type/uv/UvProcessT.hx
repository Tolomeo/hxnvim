...
@:structInit extern class UvProcessT {
	...
	**/
	...
	/**
		...
		```
	**/
	function kill(signum:haxe.extern.EitherType<Int, String>):nvim.helper.Multireturn<Null<Float>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>>;
	/**
		```lua

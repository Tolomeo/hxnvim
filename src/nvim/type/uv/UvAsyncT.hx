...
@:structInit class UvAsyncT {
	...
	**/
	...
	/**
		...
		```
	**/
	inline function send(___:haxe.Rest<nvim.type.uv.Threadargs>):nvim.helper.Multireturn.Return3<Null<Float>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>> {

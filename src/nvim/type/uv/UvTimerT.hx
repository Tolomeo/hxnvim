...
@:structInit class UvTimerT {
	...
	**/
	@:native("again")
	private extern function __again():nvim.helper.Multireturn<Null<Float>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>, nvim.helper.Nothing, nvim.helper.Nothing, nvim.helper.Nothing>;
	/**
		```lua
		(method) uv.uv_timer_t:again()
		  -> success: 0|nil
		...
		```
	**/
	inline public function again():nvim.helper.Multireturn.Return3<Null<Float>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>> {
		final result = __again();
	...
	**/
	extern public function get_due_in():Float;
	/**
		```lua
	...
	**/
	extern public function get_repeat():Float;
	/**
		```lua
	...
	**/
	...
	/**
		...
		---
		 ...
		 possible.
	**/
	extern public function set_repeat(repeat_:Float):Dynamic;
	/**
		```lua
	...
	**/
	@:native("start")
	private extern function __start(timeout:Float, repeat_:Float, callback:haxe.Constraints.Function):nvim.helper.Multireturn<Null<Float>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>, nvim.helper.Nothing, nvim.helper.Nothing, nvim.helper.Nothing>;
	/**
		```lua
		(method) uv.uv_timer_t:start(timeout: integer, repeat_: integer, callback: function)
		  -> success: 0|nil
		...
		```
	**/
	inline public function start(timeout:Float, repeat_:Float, callback:haxe.Constraints.Function):nvim.helper.Multireturn.Return3<Null<Float>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>> {
		final result = __start(timeout, repeat_, callback);
		return new nvim.helper.Multireturn.Return3<Null<Float>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>>(result._0, result._1, result._2);
	}
	/**
		```lua

...
@:structInit extern class UvIdleT {
	...
	**/
	...
	/**
		...
		```
	**/
	function start(callback:haxe.Constraints.Function):nvim.helper.Multireturn<Null<Float>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>>;
	/**
		```lua
		...
		```
	**/
	function stop(check:Any):nvim.helper.Multireturn<Null<Float>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>>;
	/**
		```lua

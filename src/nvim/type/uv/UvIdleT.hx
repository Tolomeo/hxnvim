...
@:structInit class UvIdleT {
	...
	**/
	...
	/**
		...
		```
	**/
	inline function start(callback:haxe.Constraints.Function):nvim.helper.Multireturn.Return3<Null<Float>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>> {
	...
	**/
	...
	/**
		...
		```
	**/
	inline function stop(check:Any):nvim.helper.Multireturn.Return3<Null<Float>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>> {

...
@:structInit class LuvDirT {
	...
	/**
		...
		```
	**/
	overload inline public function closedir():nvim.helper.Multireturn.Return3<Null<Bool>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>> {
	...
	/**
		...
		```
	**/
	overload inline public function closedir(callback:nvim.type.uv.fs_closedir.Callback):nvim.type.uv.UvFsT {
		callback = nvim.helper.Arg.pure(callback);
		final result = __closedir(callback);
		return result;
	}
	@:native("readdir")
	...
	/**
		...
		```
	**/
	overload inline public function readdir():nvim.helper.Multireturn.Return3<Null<lua.Table<Int, nvim.type.uv.fs_readdir.Entry>>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>> {
	...
	/**
		...
		```
	**/
	overload inline public function readdir(callback:nvim.type.uv.fs_readdir.Callback):nvim.type.uv.UvFsT {
		callback = nvim.helper.Arg.pure(callback);
		final result = __readdir(callback);
		return result;
	}
}
...
@:structInit class UvFsPollT {
	...
	**/
	...
	/**
		...
		```
	**/
	extern function getpath():nvim.helper.Multireturn<Null<String>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>, Void, Void, Void>;
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern function start(path:String, interval:Int, callback:nvim.type.uv.fs_poll_start.Callback):nvim.helper.Multireturn<Null<Float>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>, Void, Void, Void>;
	/**
		```lua

...
@:structInit extern class UvTtyT {
	...
	**/
	...
	/**
		...
		```
	**/
	function get_winsize():nvim.helper.Multireturn<Null<Int>, haxe.extern.EitherType<Int, nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>>;
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	function set_mode(mode:nvim.type.uv.tty.Mode):nvim.helper.Multireturn<Null<Float>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>>;
	/**
		```lua

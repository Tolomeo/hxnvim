...
@:structInit class UvPipeT {
	...
	**/
	...
	/**
		...
		```
	**/
	inline function bind(name:String):nvim.helper.Multireturn.Return3<Null<Float>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>> {
	...
	**/
	...
	/**
		...
		```
	**/
	inline function getpeername():nvim.helper.Multireturn.Return3<Null<String>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>> {
	...
	**/
	...
	/**
		...
		```
	**/
	inline function getsockname():nvim.helper.Multireturn.Return3<Null<String>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>> {

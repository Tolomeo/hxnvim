...
/**
	...
	```
**/
@:structInit extern class UvGetaddrinfoT {
	/**
		```lua
		...
		```
	**/
	function cancel():nvim.helper.Multireturn<Null<Float>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>, Void, Void, Void>;
	/**
		```lua

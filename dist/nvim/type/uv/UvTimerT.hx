...
@:structInit class UvTimerT {
	@:native("again")
	private extern function __again():nvim.helper.Multireturn<Null<Int>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>, nvim.helper.Nothing, nvim.helper.Nothing, nvim.helper.Nothing>;
	...
	/**
		...
		```
	**/
	inline public function again():nvim.helper.Multireturn.Return3<Null<Int>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>> {
		return __again();
	}
	...
	**/
	...
	/**
		```lua
		(method) uv.uv_timer_t:get_due_in()
		  -> integer
		```
	...
	**/
	extern public function get_due_in():Int;

	/**
		```lua
		(method) uv.uv_timer_t:get_repeat()
		  -> integer
		```
	...
	**/
	extern public function get_repeat():Int;
	...
	**/
	...
	/**
		```lua
		(method) uv.uv_timer_t:set_repeat(repeat_: integer)
		```
		...
		---
		 ...
		 possible.
	**/
	extern public function set_repeat(repeat_:Int):Dynamic;

	@:native("start")
	private extern function __start(timeout:Int, repeat_:Int, callback:haxe.Constraints.Function):nvim.helper.Multireturn<Null<Int>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>, nvim.helper.Nothing, nvim.helper.Nothing, nvim.helper.Nothing>;

	/**
		```lua
		(method) uv.uv_timer_t:start(timeout: integer, repeat_: integer, callback: function)
		  -> success: 0|nil
		  2. err: string|nil
		  3. err_name: "E2BIG"|"EACCES"|"EADDRINUSE"|"EADDRNOTAVAIL"|"EAFNOSUPPORT"|"EAGAIN"|"EAI_ADDRFAMILY"|"EAI_AGAIN"|"EAI_BADFLAGS"|"EAI_BADHINTS"|"EAI_CANCELED"|"EAI_FAIL"|"EAI_FAMILY"|"EAI_MEMORY"...(too long)...KNOWN"|nil
		```
		...
		@*param* `timeout` — Timeout, in milliseconds. If timeout is zero, the callback fires on the next event loop iteration.
		
		@*param* `repeat_` — Repeat interval, in milliseconds. If non-zero, the callback fires after `timeout` milliseconds and then repeatedly after `repeat_` milliseconds.
		...
		```
	**/
	inline public function start(timeout:Int, repeat_:Int, callback:haxe.Constraints.Function):nvim.helper.Multireturn.Return3<Null<Int>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>> {
		return __start(timeout, repeat_, callback);
	}

	@:native("stop")
	private extern function __stop():nvim.helper.Multireturn<Null<Int>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>, nvim.helper.Nothing, nvim.helper.Nothing, nvim.helper.Nothing>;

	/**
		```lua
		(method) uv.uv_timer_t:stop()
		  -> success: 0|nil
		  2. err: string|nil
		  3. err_name: "E2BIG"|"EACCES"|"EADDRINUSE"|"EADDRNOTAVAIL"|"EAFNOSUPPORT"|"EAGAIN"|"EAI_ADDRFAMILY"|"EAI_AGAIN"|"EAI_BADFLAGS"|"EAI_BADHINTS"|"EAI_CANCELED"|"EAI_FAIL"|"EAI_FAMILY"|"EAI_MEMORY"...(too long)...KNOWN"|nil
		```
		...
		```
	**/
	inline public function stop():nvim.helper.Multireturn.Return3<Null<Int>, Null<nvim.type.uv.error.Message>, Null<nvim.type.uv.error.Name>> {
		return __stop();
	}

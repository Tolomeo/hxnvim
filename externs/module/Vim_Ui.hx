...
@:luaRequire("vim.ui") extern class Vim_Ui {
	...
	**/
	extern static function input(opts:Null<lua.Table.AnyTable>, on_confirm:Dynamic):Dynamic;
	/**
		```lua
	...
	**/
	extern static function open(path:String, ?opt:{ var cmd : Null<Array<String>>; }):vim._internal.Multireturn<haxe.extern.EitherType<externs.type.Vim_SystemObj, Void>, haxe.extern.EitherType<Void, String>>;
	/**
		```lua
		...
		@*param* `opts` — Additional options
		     ...
		     - kind (string|nil)
		               ...
		               `nil` if the user aborted the dialog.
	**/
	extern static function select<T>(items:Array<externs.type.T>, opts:lua.Table.AnyTable, on_choice:(item:haxe.extern.EitherType<externs.type.T, Void>, idx:haxe.extern.EitherType<Int, Void>) -> Dynamic):Dynamic;
}
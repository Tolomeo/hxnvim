...
@:native("vim.lsp.completion") extern class Vim_Lsp_Completion {
	...
	**/
	extern static function enable(enable:Bool, client_id:Int, bufnr:Int, ?opts:externs.type.Vim_Lsp_Completion_BufferOpts):Dynamic;
	/**
		```lua
		...
		---
		 ...
		 ```
	**/
	extern static function get(?opts:externs.type.Vim_Lsp_Completion_Get_Opts):Dynamic;
}
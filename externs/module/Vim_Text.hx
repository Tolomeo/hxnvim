...
@:luaRequire("vim.text") extern class Vim_Text {
	...
	**/
	extern static function hexdecode(enc:String):vim._internal.Multireturn<Null<String>, Null<String>>;
	/**
		```lua
	...
	**/
	extern static function hexencode(str:String):String;
	/**
		```lua
	...
	**/
	extern static function indent(size:Int, text:String, ?opts:{ var expandtab : Null<Float>; }):vim._internal.Multireturn<String, Int>;
}
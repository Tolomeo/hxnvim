...
@:native("vim.glob") extern class Vim_Glob {
	/**
		...
		@*param* `pattern` — The raw glob pattern
		
		@*return* `pattern` — An |lua-lpeg| representation of the pattern
	**/
	extern static function to_lpeg(pattern:String):externs.type.Vim_Lpeg_Pattern;
}
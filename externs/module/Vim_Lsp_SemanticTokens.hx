...
@:native("vim.lsp.semantic_tokens") extern class Vim_Lsp_SemanticTokens {
	/**
		...
		@*param* `bufnr` — filter by buffer. All buffers if nil, current
		       ...
		       buffer if 0
	**/
	extern static function force_refresh(bufnr:haxe.extern.EitherType<Int, Void>):Dynamic;
	/**
		```lua
		...
		@*return* — (table|nil) List of tokens at position. Each token has
		        ...
		        - client_id (integer)
	**/
	extern static function get_at_pos(bufnr:haxe.extern.EitherType<Int, Void>, row:haxe.extern.EitherType<Int, Void>, col:haxe.extern.EitherType<Int, Void>):haxe.extern.EitherType<Array<externs.type.STTokenRangeInspect>, Void>;
	/**
		```lua
	...
	**/
	extern static function highlight_token(token:lua.Table.AnyTable, bufnr:Int, client_id:Int, hl_group:String, ?opts:externs.type.Vim_Lsp_SemanticTokens_HighlightToken_Opts):Dynamic;
	/**
		```lua
	...
	**/
	extern static function start(bufnr:Int, client_id:Int, ?opts:lua.Table.AnyTable):Dynamic;
	/**
		```lua
		...
		@*param* `client_id` — The ID of the |vim.lsp.Client|
	**/
	extern static function stop(bufnr:Int, client_id:Int):Dynamic;
}
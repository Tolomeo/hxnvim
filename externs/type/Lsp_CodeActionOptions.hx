...
**/
@:native("lsp.CodeActionOptions") extern class Lsp_CodeActionOptions {
	/**
		```lua
	...
	**/
	extern var codeActionKinds : Null<Array<externs.type.Lsp_CodeActionKind>>;
	/**
		```lua
	...
	**/
	extern var documentation : Null<Array<externs.type.Lsp_CodeActionKindDocumentation>>;
	/**
		```lua

...
**/
@:native("uv.uv_signal_t") extern class Uv_UvSignalT {
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern function start(signum:haxe.extern.EitherType<Int, String>, callback:externs.type.Uv_SignalStart_Callback):vim._internal.Multireturn<haxe.extern.EitherType<Float, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Message, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Name, Void>>;
	/**
		```lua
		...
		```
	**/
	extern function start_oneshot(signum:haxe.extern.EitherType<Int, String>, callback:externs.type.Uv_SignalStartOneshot_Callback):vim._internal.Multireturn<haxe.extern.EitherType<Float, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Message, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Name, Void>>;
	/**
		```lua

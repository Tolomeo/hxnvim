...
@:private extern class AttachedBuffers {
...
/**
	...
	```
**/
@:native("vim.lsp.Client") extern class Vim_Lsp_Client {
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern var attached_buffers : AttachedBuffers;
	/**
		```lua
	...
	**/
	extern var config : externs.type.Vim_Lsp_ClientConfig;
	/**
		```lua
		...
		---
		 ...
		 @nodoc
	**/
	extern static function create(config:externs.type.Vim_Lsp_ClientConfig):Null<externs.type.Vim_Lsp_Client>;
	/**
		```lua
	...
	**/
	extern var dynamic_capabilities : externs.type.Lsp_DynamicCapabilities;
	/**
		```lua
	...
	**/
	extern var flags : externs.type.Vim_Lsp_Client_Flags;
	/**
		```lua
		...
		```
	**/
	extern function get_language_id(bufnr:Int, filetype:String):String;
	/**
		```lua
	...
	**/
	...
	/**
		...
		---
		 ...
		 sent by the server.
	**/
	extern var progress : externs.type.Vim_Lsp_Client_Progress;
	/**
		```lua
	...
	**/
	extern var rpc : externs.type.Vim_Lsp_Rpc_PublicClient;
	/**
		```lua
	...
	**/
	extern var server_capabilities : Null<externs.type.Lsp_ServerCapabilities>;
	/**
		```lua
	...
	**/
	extern var server_info : Null<externs.type.Lsp_ServerInfo>;
	/**
		```lua
		...
		---
		 ...
		 See [vim.lsp.ClientConfig].
	**/
	extern var settings : externs.type.Lsp_LSPObject;
	/**
		```lua
	...
	**/
	extern function _add_workspace_folder(dir:Null<String>):Dynamic;
	/**
		```lua
		...
		```
	**/
	extern function _get_registration(method:String, ?bufnr:Int):Null<externs.type.Lsp_Registration>;
	/**
		```lua
	...
	**/
	extern function _get_registration_options(method:String, ?bufnr:Int):Null<externs.type.Lsp_LSPAny>;
	/**
		```lua
		(method) vim.lsp.Client:_register(registrations: lsp.Registration[])
		```
	**/
	extern function _register(registrations:Array<externs.type.Lsp_Registration>):Dynamic;
	/**
		```lua
	...
	**/
	extern function _remove_workspace_folder(dir:Null<String>):Dynamic;
	/**
		```lua
		...
		---
		 ...
		 Get options for a method that is registered dynamically.
	**/
	extern function _supports_registration(method:String):Dynamic;
	/**
		```lua
	...
	**/
	extern function _text_document_did_open_handler(bufnr:Int):Dynamic;
	/**
		```lua
		(method) vim.lsp.Client:_unregister(unregistrations: lsp.Unregistration[])
		```
	**/
	extern function _unregister(unregistrations:Array<externs.type.Lsp_Unregistration>):Dynamic;
	/**
		```lua
	...
	**/
	extern function exec_cmd(command:externs.type.Lsp_Command, ?context:{ var bufnr : Null<Int>; }, ?handler:externs.type.Lsp_Handler):Dynamic;
	/**
		```lua
		...
		---
		 ...
		 @nodoc
	**/
	extern function initialize():Dynamic;
	/**
		```lua
	...
	**/
	extern function is_stopped():Bool;
	/**
		```lua
	...
	**/
	extern function notify(method:String, params:Null<lua.Table.AnyTable>):Bool;
	/**
		```lua
	...
	**/
	extern function request(method:String, ?params:lua.Table.AnyTable, ?handler:externs.type.Lsp_Handler, ?bufnr:Int):vim._internal.Multireturn<Bool, Null<Int>>;
	/**
		```lua
	...
	**/
	extern function request_sync(method:String, params:lua.Table.AnyTable, timeout_ms:Null<Int>, ?bufnr:Int):vim._internal.Multireturn<Null<{ var err : Null<externs.type.Lsp_ResponseError>; var result : Any; }>, Null<String>>;
	/**
		```lua
	...
	**/
	extern function stop(?force:Bool):Dynamic;
	/**
		```lua
	...
	**/
	extern function supports_method(method:String, ?bufnr:Int):Dynamic;
}
...
**/
@:native("lsp.CodeActionClientCapabilities") extern class Lsp_CodeActionClientCapabilities {
	/**
		```lua
	...
	**/
	extern var codeActionLiteralSupport : Null<externs.type.Lsp_ClientCodeActionLiteralOptions>;
	/**
		```lua
	...
	**/
	extern var resolveSupport : Null<externs.type.Lsp_ClientCodeActionResolveOptions>;
	/**
		```lua
	...
	**/
	extern var tagSupport : Null<externs.type.Lsp_CodeActionTagOptions>;
}
...
/**
	...
	```
**/
@:native("lsp.ImplementationRegistrationOptions") extern class Lsp_ImplementationRegistrationOptions {
	/**
		```lua
	...
	**/
	...
	/**
		```lua
		(field) lsp.ImplementationRegistrationOptions.id: string?
		```
	...
	**/
	...
	/**
		```lua
		(field) lsp.ImplementationRegistrationOptions.workDoneProgress: boolean?
		```
	**/

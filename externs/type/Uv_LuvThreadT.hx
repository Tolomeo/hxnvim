...
**/
@:structInit extern class Uv_LuvThreadT {
	/**
		```lua
	...
	**/
	extern function equal(other_thread:externs.type.Uv_LuvThreadT):Bool;
	/**
		```lua
		...
		```
	**/
	extern function join():vim._internal.Multireturn<haxe.extern.EitherType<Bool, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Message, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Name, Void>>;
}
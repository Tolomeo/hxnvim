...
/**
	...
	```
**/
@:native("lsp.ClientCompletionItemOptionsKind") extern class Lsp_ClientCompletionItemOptionsKind {
	/**
		```lua
	...
	**/
	extern var valueSet : Null<Array<externs.type.Lsp_CompletionItemKind>>;
}
...
**/
@:structInit extern class Uv_UvTtyT {
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern function get_winsize():vim._internal.Multireturn<haxe.extern.EitherType<Int, Void>, haxe.extern.EitherType<Int, externs.type.Uv_Error_Message>, haxe.extern.EitherType<externs.type.Uv_Error_Name, Void>>;
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern function set_mode(mode:externs.type.Uv_Tty_Mode):vim._internal.Multireturn<haxe.extern.EitherType<Float, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Message, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Name, Void>>;
	/**
		```lua

...
**/
@:native("uv.uv_poll_t") extern class Uv_UvPollT {
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern function start(events:externs.type.Uv_Poll_Eventspec, callback:externs.type.Uv_PollStart_Callback):vim._internal.Multireturn<haxe.extern.EitherType<Float, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Message, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Name, Void>>;
	/**
		```lua

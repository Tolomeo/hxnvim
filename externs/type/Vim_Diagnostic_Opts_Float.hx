...
/**
	...
	```
**/
@:native("vim.diagnostic.Opts.Float") extern class Vim_Diagnostic_Opts_Float {
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern var prefix : Null<haxe.extern.EitherType<String, haxe.extern.EitherType<lua.Table.AnyTable, (diagnostic:externs.type.Vim_Diagnostic, i:Int, total:Int) -> vim._internal.Multireturn<String, String>>>>;
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern var suffix : Null<haxe.extern.EitherType<String, haxe.extern.EitherType<lua.Table.AnyTable, (diagnostic:externs.type.Vim_Diagnostic, i:Int, total:Int) -> vim._internal.Multireturn<String, String>>>>;
}
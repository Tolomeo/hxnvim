...
**/
@:structInit extern class Lsp_DocumentSymbol {
	/**
		```lua
	...
	**/
	extern var children : Null<Array<externs.type.Lsp_DocumentSymbol>>;
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern var kind : externs.type.Lsp_SymbolKind;
	/**
		```lua
	...
	**/
	extern var selectionRange : externs.type.Lsp_Range;
	/**
		```lua
	...
	**/
	extern var tags : Null<Array<externs.type.Lsp_SymbolTag>>;
}
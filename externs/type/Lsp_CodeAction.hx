...
**/
@:native("lsp.CodeAction") extern class Lsp_CodeAction {
	/**
		```lua
	...
	**/
	extern var diagnostics : Null<Array<externs.type.Lsp_Diagnostic>>;
	/**
		```lua
	...
	**/
	extern var disabled : Null<externs.type.Lsp_CodeActionDisabled>;
	/**
		```lua
	...
	**/
	extern var edit : Null<externs.type.Lsp_WorkspaceEdit>;
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern var kind : Null<externs.type.Lsp_CodeActionKind>;
	/**
		```lua
	...
	**/
	extern var tags : Null<Array<externs.type.Lsp_CodeActionTag>>;
	/**
		```lua

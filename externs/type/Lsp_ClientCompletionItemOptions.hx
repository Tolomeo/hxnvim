...
/**
	...
	```
**/
@:structInit extern class Lsp_ClientCompletionItemOptions {
	/**
		```lua
	...
	**/
	extern var insertTextModeSupport : Null<externs.type.Lsp_ClientCompletionItemInsertTextModeOptions>;
	/**
		```lua
	...
	**/
	extern var resolveSupport : Null<externs.type.Lsp_ClientCompletionItemResolveOptions>;
	/**
		```lua
	...
	**/
	extern var tagSupport : Null<externs.type.Lsp_CompletionItemTagOptions>;
}
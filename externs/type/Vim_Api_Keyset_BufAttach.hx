...
/**
	...
	```
**/
@:structInit extern class Vim_Api_Keyset_BufAttach {
	/**
		```lua
		...
		```
	**/
	extern var on_bytes : Null<(_:String, bufnr:Int, changedtick:Int, start_row:Int, start_col:Int, start_byte:Int, old_end_row:Int, old_end_col:Int, old_end_byte:Int, new_end_row:Int, new_end_col:Int, new_end_byte:Int) -> Null<Bool>>;
	/**
		```lua
		...
		```
	**/
	extern var on_changedtick : Null<(_:String, bufnr:Int, changedtick:Int) -> Dynamic>;
	/**
		```lua
		...
		```
	**/
	extern var on_detach : Null<(_:String, bufnr:Int) -> Dynamic>;
	/**
		```lua
		...
		```
	**/
	extern var on_lines : Null<(_:String, bufnr:Int, changedtick:Int, first:Int, last_old:Int, last_new:Int, byte_count:Int, deleted_codepoints:Int, deleted_codeunits:Int) -> Null<Bool>>;
	/**
		```lua
		...
		```
	**/
	extern var on_reload : Null<(_:String, bufnr:Int) -> Dynamic>;
	/**
		```lua
		(field) vim.api.keyset.buf_attach.preview: boolean?
		```
	**/
	extern var preview : Null<Bool>;
	/**
		```lua
		(field) vim.api.keyset.buf_attach.utf_sizes: boolean?
		```
	**/
	extern var utf_sizes : Null<Bool>;
}
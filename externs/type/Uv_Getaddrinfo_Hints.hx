...
/**
	...
	```
**/
@:structInit extern class Uv_Getaddrinfo_Hints {
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern var family : haxe.extern.EitherType<String, haxe.extern.EitherType<Int, externs.type.Uv_Socket_Family>>;
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern var protocol : haxe.extern.EitherType<String, haxe.extern.EitherType<Int, externs.type.Uv_Socket_Protocol>>;
	/**
		```lua
		...
		```
	**/
	extern var socktype : haxe.extern.EitherType<String, haxe.extern.EitherType<Int, externs.type.Uv_Socket_Type>>;
	/**
		```lua

...
**/
@:structInit extern class Uv_UvPrepareT {
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern function start(callback:haxe.Constraints.Function):vim._internal.Multireturn<haxe.extern.EitherType<Float, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Message, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Name, Void>>;
	/**
		```lua

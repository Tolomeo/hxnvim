...
**/
@:native("uv.uv_idle_t") extern class Uv_UvIdleT {
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern function stop(check:Any):vim._internal.Multireturn<haxe.extern.EitherType<Float, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Message, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Name, Void>>;
	/**
		```lua

...
**/
@:native("uv.uv_process_t") extern class Uv_UvProcessT {
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern function kill(signum:haxe.extern.EitherType<Int, String>):vim._internal.Multireturn<haxe.extern.EitherType<Float, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Message, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Name, Void>>;
	/**
		```lua

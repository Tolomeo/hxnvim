...
/**
	...
	```
**/
@:native("uv.uv_getaddrinfo_t") extern class Uv_UvGetaddrinfoT {
	/**
		```lua
		...
		```
	**/
	extern function cancel():vim._internal.Multireturn<haxe.extern.EitherType<Float, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Message, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Name, Void>>;
	/**
		```lua

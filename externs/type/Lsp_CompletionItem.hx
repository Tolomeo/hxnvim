...
**/
@:structInit extern class Lsp_CompletionItem {
	/**
		```lua
	...
	**/
	extern var additionalTextEdits : Null<Array<externs.type.Lsp_TextEdit>>;
	/**
		```lua
	...
	**/
	extern var documentation : Null<haxe.extern.EitherType<String, externs.type.Lsp_MarkupContent>>;
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern var insertTextFormat : Null<externs.type.Lsp_InsertTextFormat>;
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern var kind : Null<externs.type.Lsp_CompletionItemKind>;
	/**
		```lua
	...
	**/
	extern var labelDetails : Null<externs.type.Lsp_CompletionItemLabelDetails>;
	/**
		```lua
	...
	**/
	extern var tags : Null<Array<externs.type.Lsp_CompletionItemTag>>;
	/**
		```lua
	...
	**/
	extern var textEdit : Null<haxe.extern.EitherType<externs.type.Lsp_TextEdit, externs.type.Lsp_InsertReplaceEdit>>;
	/**
		```lua

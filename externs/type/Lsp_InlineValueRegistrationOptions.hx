...
/**
	```lua
	(class) lsp.InlineValueRegistrationOptions
	```
...
**/
@:native("lsp.InlineValueRegistrationOptions") extern class Lsp_InlineValueRegistrationOptions {
	/**
		```lua
	...
	**/
	...
	/**
		```lua
		(field) lsp.InlineValueRegistrationOptions.id: string?
		```
	...
	**/
	...
	/**
		```lua
		(field) lsp.InlineValueRegistrationOptions.workDoneProgress: boolean?
		```
	**/

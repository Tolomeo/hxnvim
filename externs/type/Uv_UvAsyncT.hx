...
**/
@:native("uv.uv_async_t") extern class Uv_UvAsyncT {
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern function send(___:haxe.Rest<externs.type.Uv_Threadargs>):vim._internal.Multireturn<haxe.extern.EitherType<Float, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Message, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Name, Void>>;
	/**
		```lua

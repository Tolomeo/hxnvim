...
**/
@:native("lsp.InlayHint") extern class Lsp_InlayHint {
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern var kind : Null<externs.type.Lsp_InlayHintKind>;
	/**
		```lua
	...
	**/
	extern var label : haxe.extern.EitherType<String, Array<externs.type.Lsp_InlayHintLabelPart>>;
	/**
		```lua
	...
	**/
	extern var position : externs.type.Lsp_Position;
	/**
		```lua
	...
	**/
	extern var textEdits : Null<Array<externs.type.Lsp_TextEdit>>;
	/**
		```lua
	...
	**/
	extern var tooltip : Null<haxe.extern.EitherType<String, externs.type.Lsp_MarkupContent>>;
}
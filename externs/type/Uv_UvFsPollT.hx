...
**/
@:native("uv.uv_fs_poll_t") extern class Uv_UvFsPollT {
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern function getpath():vim._internal.Multireturn<haxe.extern.EitherType<String, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Message, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Name, Void>>;
	/**
		```lua
	...
	**/
	...
	/**
		...
		```
	**/
	extern function start(path:String, interval:Int, callback:externs.type.Uv_FsPollStart_Callback):vim._internal.Multireturn<haxe.extern.EitherType<Float, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Message, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Name, Void>>;
	/**
		```lua

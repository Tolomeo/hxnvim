...
@:structInit extern class Uv_UvFsEventT {
	...
	**/
	...
	/**
		...
		```
	**/
	extern function start(path:String, flags:externs.type.Uv_FsEventStart_Flags, callback:externs.type.Uv_FsEventStart_Callback):vim._internal.Multireturn<haxe.extern.EitherType<Float, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Message, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Name, Void>>;
	/**
		```lua

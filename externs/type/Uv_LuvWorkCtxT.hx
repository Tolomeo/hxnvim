...
**/
@:structInit extern class Uv_LuvWorkCtxT {
	/**
		```lua
		...
		```
	**/
	extern function queue(___:haxe.Rest<externs.type.Uv_Threadargs>):vim._internal.Multireturn<haxe.extern.EitherType<Bool, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Message, Void>, haxe.extern.EitherType<externs.type.Uv_Error_Name, Void>>;
}